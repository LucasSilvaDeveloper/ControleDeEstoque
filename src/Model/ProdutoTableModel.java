...
public class ProdutoTableModel extends AbstractTableModel {
    ...
    private String[] colunas = {"ID", "NOME", "QTD", "v/compra litro", "V/venda litro", "DATA COMPRA", "DESCRIÇÃO"};
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        switch (coluna) {
            ...
            case 3:
                return dados.get(linha).getValordecompra();
            case 4:
                return dados.get(linha).getValordevenda();
            case 5:
